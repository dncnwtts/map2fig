...
fn test_triangle_vertex_calculation() {
    ...
    eprintln!("  cbar_width_f64 = {:.1}, cbar_width = {}", cbar_width_f64, cbar_width);
    ...
    eprintln!("Gradient bounds: {} to {} (height {})", gradient_top, gradient_bottom, cbar_h_truncated);
    
    let gradient_center_f64 = (gradient_top as f64 + gradient_bottom as f64) / 2.0;
    let tip_y = gradient_center_f64.ceil() as i32;
    
    eprintln!("Tip Y: gradient_center = {:.1}, tip_y = {}", gradient_center_f64, tip_y);
    ...
    eprintln!("Base Y: half_height = {:.1}, base_top = {}, base_bottom = {}", half_height, base_top_y, base_bottom_y);
    ...
    for y_test in vec![76, 77, 78] {
        ...
        eprintln!("  Range: [{:.1}..{:.1}], rounded: [{:}..{:}], clamped: [{:}..{:}]", x_min_f, x_max_f, x_min_i, x_max_i, x_min_clamped, x_max_clamped);
