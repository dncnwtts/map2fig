...
fn test_edge_asymmetry_analysis() {
    ...
    for distance in 24..=30 {
        ...
        if !top_pixels.is_empty() && !bot_pixels.is_empty() {
            ...
            println!("    Width: top={}, bot={} (diff={}), Left edge: top={}, bot={} (diff={})",
                top_width, bot_width, (top_width as i32 - bot_width as i32),
                top_left, bot_left, (top_left as i32 - bot_left as i32));
        }
    }
}
